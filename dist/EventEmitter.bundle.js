...
var EventEmitter = /*#__PURE__*/function () {
  ...
  _createClass(EventEmitter, [{
    ...
    value: function emit(key) {
      ...
      if (EventEmitter.__$.set(key, EventEmitter.__$.get(key) ? EventEmitter.__$.get(key).concat($functionSet) : [].concat($functionSet))) return;else {
    ...
    value: function triggerOne(key, index) {
      ...
      this.getOne(key, index).apply(void 0, args);
    }
    /**
